...
test('Should return proper board data string from a puzzle data with limit', () => {
    ...
    expect(solvedBoardString).toBe(`{x:0,y:0,s:2}{x:1,y:0,s:2}{x:2,y:0,s:2}{x:3,y:0,s:2}{x:0,y:1,s:2}{x:1,y:1,s:2}{x:2,y:1,s:2}{x:3,y:1,s:2}`);
});
